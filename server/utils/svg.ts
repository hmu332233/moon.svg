export const createMoon = (
  ...
  const moonShadow = shadow
    ? `<g className="moon-shadow" xmlns="http://www.w3.org/2000/svg" transform="translate(0, 320) scale(0.246, -0.246)" fill="rgba(239, 234, 143, 0.75)" stroke="none">
    ...
    <path d="M505 904 c-12 -18 -14 -29 -6 -37 15 -15 41 10 41 39 0 31 -14 30 -35 -2z"/>
    <path d="M373 713 c-27 -5 -30 -19 -5 -27 9 -3 0 -4 -20 -3 -42 3 -42 3 -28 -24 15 -26 53 -24 87 6 15 13 22 25 16 25 -7 0 -13 7 -13 15 0 8 -3 14 -7 14 -5 -1 -18 -4 -30 -6z"/>
    <path d="M265 581 c-9 -16 6 -41 26 -41 19 0 25 17 11 35 -10 14 -30 17 -37 6z"/>
    <path d="M530 539 c0 -5 7 -9 15 -9 8 0 15 -4 15 -10 0 -5 7 -10 16 -10 13 0 14 3 5 14 -14 17 -51 28 -51 15z"/>
    </g>`
    : '';
  // 거기에 clip-path: path: "m 160 10 a ${rx1} ${ry1} 0 1 ${flag1} 0 300 a ${rx2} ${ry2} 0 1 ${flag2} 0 -300
